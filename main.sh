...
Suffix="\033[0m"
#link izin ip vps
url_izin='https://raw.githubusercontent.com/figogove/ip/master/ip'
...
function add_domain() {
    ...
    echo -e "${red}    鈾︼笍${NC} ${green} CUSTOM SETUP DOMAIN VPS     ${NC}"
    echo -e "${red}鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣\033[0m${NC}"
...
"
    ...
    clear
    echo "    鈹屸攢鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�"
    echo "    鈹�       >>> Service & Port                            鈹�"
    echo "    鈹�   - Open SSH                : 443, 80, 39           鈹�"
    echo "    鈹�   - DNS (SLOWDNS)           : 443, 80, 53           鈹�"
    echo "    鈹�   - Dropbear                : 443, 109, 80          鈹�"
    echo "    鈹�   - Dropbear Websocket      : 443, 109              鈹�"
    echo "    鈹�   - SSH Websocket SSL       : 443                   鈹�"
    echo "    鈹�   - SSH Websocket           : 80                    鈹�"
    echo "    鈹�   - OpenVPN SSL             : 1194                  鈹�"
    echo "    鈹�   - OpenVPN Websocket SSL   : 443                   鈹�"
    echo "    鈹�   - OpenVPN TCP             : 1194                  鈹�"
    echo "    鈹�   - OpenVPN UDP             : 2200                  鈹�"
    echo "    鈹�   - Nginx Webserver         : 443, 80, 81           鈹�"
    echo "    鈹�   - Haproxy Loadbalancer    : 443, 80               鈹�"
    echo "    鈹�   - DNS Server              : 443, 53               鈹�"
    echo "    鈹�   - DNS Client              : 443, 88               鈹�"
    echo "    鈹�   - XRAY DNS (SLOWDNS)      : 443, 80, 53           鈹�"
    echo "    鈹�   - XRAY Vmess TLS          : 443                   鈹�"
    echo "    鈹�   - XRAY Vmess gRPC         : 443                   鈹�"
    echo "    鈹�   - XRAY Vmess None TLS     : 80                    鈹�"
    echo "    鈹�   - XRAY Vless TLS          : 443                   鈹�"
    echo "    鈹�   - XRAY Vless gRPC         : 443                   鈹�"
    echo "    鈹�   - XRAY Vless None TLS     : 80                    鈹�"
    echo "    鈹�   - Trojan gRPC             : 443                   鈹�"
    echo "    鈹�   - Trojan WS               : 443                   鈹�"
    echo "    鈹�   - Shadowsocks WS          : 443                   鈹�"
    echo "    鈹�   - Shadowsocks gRPC        : 443                   鈹�"
    echo "    鈹�                                                     鈹�"
    echo "    鈹�      >>> Server Information & Other Features        鈹�"
    echo "    鈹�   - Timezone                : Asia/Jakarta (GMT +7) 鈹�"
    echo "    鈹�   - Autoreboot On    : $AUTOREB:00 $TIME_DATE GMT +7鈹�"
    echo "    鈹�   - Auto Delete Expired Account  : per 23:30        鈹�"
    echo "    鈹�   - FAuto Clear Log.   : Per 30 Menit               鈹�"
    echo "    鈹�   - Fully automatic script                          鈹�"
    echo "    鈹�   - VPS settings                                    鈹�"
    echo "    鈹�   - Admin Control                                   鈹�"
    echo "    鈹�   - Restore Data                                    鈹�"
    echo "    鈹�   - Full Orders For Various Services                鈹�"
    echo "    鈹斺攢鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�"
